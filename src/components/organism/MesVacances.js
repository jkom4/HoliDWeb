            ...
            <div className="px-2 py-1 mx-auto ">
                <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-lg ">
                    ...
                    <div className="mt-6 grid w-full grid-cols-2 justify-end space-x-4 md:flex">
                        ...
                        <button onClick={handleSearch} className="active:scale-95 rounded-lg bg-blue-700 px-8 py-2 font-medium text-white outline-none focus:ring hover:opacity-90">Search</button>
                    </div>
                </div>
            </div>
            {/*Liste de vacance*/}
            ...
            {onSearch.map(vacance => (
                <div className="flex-1   max-w-screen-lg px-2 py-1 mx-auto text-left  ">
                    <div className="p-4  rounded-md bg-white  ">
                        ...
                        <div className="flex items-center justify-between">
                            <a onClick={() => handleItemClick(vacance)} className="flex-1">
